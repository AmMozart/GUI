...
var area = 1;
var lastCommand = 0;
var SwitchLoads = ['S115', 'S026', 'S0261', 'S006','D001', 'D002', 'D003', 'S004', 'D005', 'D104', 'S0061', 'S007', 'S008', 'D009', 'D010', 'D011', 'D012', 'D0121', 'S013', 'D014', 'D015', 'D016', 'S017', 'D018', 'D019', 'S020', 'D021', 'D022', 'D023', 'D024', 'S025',  'S027', 'D028','SL01','SL02','SL03','D1011','S102','D1051','D107','D109','D110','D111','D112','D113','D114','D116','D138','D139','D140','D142','S143','D117','D118','S120','S121','S144','D119','D141','D105','D106','S126','S1261','S128','D127','S1311','S134','D131',
'D132','S130','S1301','S136','S1351','S124','S1241','D135', 'D125', 'D137', 'D1013', 'S1012', 'S1231','S124','S1241','D122','D123','D201','S224','S220','S221','D216','D217','D218','D219','S222','S2221','S223','S214','D211','D212','S202','S207','S2071','D205','D206','D208','S209','S2091','D204','D203','D301',
'S3011','D302', 'D303','S3031','S306','D307','S305','S3051','D304','S308','S3081','D4101'];
var DimmerLoads = ['D001', 'D002', 'D003', 'D005', 'D009', 'D010', 'D011', 'D012', 'D0121', 'D014', 'D015', 'D016', 'D018', 'D019', 'D021', 'D022', 'D023', 'D024', 'D028','D1011','D1051','D107', 'D104', 'D109','D110','D111','D112','D113','D114','D116','D138','D139','D140','D142','D117','D118','D119','D141','D105','D106','D127','D131',
'D132','D135','D137','D122','D123', 'D1013', 'D125', 'D201','D216','D217','D218','D219','D211','D212','D205','D206','D208','D204','D203','D301',
'D303','D307', 'D302', 'D304','D4101'];
...
function ControlDimm(stateIndex, value) {
    ...
    var control32 = 240 << 8;                               // DMX ПРОТОКОЛ 240
...
$(document).ready(function () {
    ...
    $('#picker').mousedown(function(e) { // click event handler
        bCanPreview = true;
    }); 
    $('#picker').mouseup(function(e) { // click event handler
        bCanPreview = false;
        getValueRGB(e);
    });
